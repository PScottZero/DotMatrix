...
unsigned char CPU::add(unsigned char a, unsigned char b) {
...
unsigned char CPU::addCarry(unsigned char a, unsigned char b) {
...
// Input: a (unsigned char), b (unsigned char)
// Output: a - b (unsigned char)
unsigned char CPU::sub(unsigned char a, unsigned char b) {
    short result = a - b;
    zero = result == 0;
...
// Input: a (unsigned char), b (unsigned char)
// Output: a - b - carry (unsigned char)
unsigned char CPU::subCarry(unsigned char a, unsigned char b) {
